...
public class ChangePhoneNumUseCase {
    ...
    @Transactional
    public void execute(Long userId, ChangePhoneNumRequest request) {
        ...
        user.changePhoneNum(encryptionUtils.encrypt(request.phoneNum()));
    }
}
